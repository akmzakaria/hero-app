    ...
    return (
        <div className='bg-[#f5f5f5] pt-5 md:pt-8'>
            ...
            <div className='md:max-w-[1400px] mx-auto mb-8 md:pb-12'>
                <h1 className='text-center text-[#001931] md:text-5xl text-2xl font-bold mb-2 md:mb-8'>Our All Applications</h1>
                <p className='text-center text-[#627382] md:text-xl mb-8'>Explore All Apps on the Market developed by us. We code for Millions</p>
...

                {
                    isLoading ?
                        <div className='flex h-[55vh] bg-[#f5f5f5] justify-center'>
                            <span className="loading loading-dots w-25"></span>
                        </div> :
                        <div>
